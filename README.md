...
<h2 align="center">Skills and Tools Used</h2>
    <table style="width: 100%; border-collapse: collapse; margin: 0 auto; border: 2px solid #fe019a;" align="center">
    <thead>
        <tr>
            <th style="text-align: center; padding: 0; border: 2px solid #fe019a;"><h4>Front-end</h4></th>
            <th style="text-align: center; padding: 0; border: 2px solid #fe019a;"><h4>Back-end and Database</h4></th>
            <th style="text-align: center; padding: 0; border: 2px solid #fe019a;"><h4>Tools Used</h4></th>
            <th style="text-align: center; padding: 0; border: 2px solid #fe019a;"><h4>Photo Editing</h4></th>
        </tr>
    </thead>
    <tbody>
        <tr>
